...
conn = sqlite3.connect('newsdb_v6.sqlite')
...
papers = 'NewsPapers.json'
#papers = 'test.json'
with open(papers) as data_file:
...
for company, value in companies.items():
    ...
    if 'rss' in value:
        ...
        for content in paper.articles:
            ...
            # After 200 downloaded articles from the same newspaper without publish date, the company will be skipped.
            if (content.publish_date is None and content.authors is None) :
